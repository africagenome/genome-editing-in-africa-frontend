...
const InteractiveMap = () => {
  ...
  const countryData = {
    ...
    egypt: {
      ...
      trend: 'Recent developments in GEd enable new food products to reach the market quickly and at affordable prices. Genome editing in Egypt is expanding rapidly. National government agencies (i.e., STDF and ASRT) are strengthening GEd capacity by funding more than eight research projects, with AGERI and CUFA as leading beneficiaries. To raise public awareness, NGOs such as EBIC-ISAAA and the Alliance for Science (AfS) have conducted training and workshops to distinguish genome editing from transgenic GMOs.'
    },
    tunisia: {
      name: 'Tunisia',
      activity: 'low',
      projects: 0,
      institutionalCapacity: 8,
      priorityOrganisms: 8,
      agreements: [
    ...
    'burkina-faso': {
      ...
      trend: 'Burkina Faso has a robust regulatory framework, a committed scientific community, and a proven track record in agricultural biotechnology. The nation is well-positioned to harness genome editing for sustainable development.'
    },
    cameroon: {
      name: 'Cameroon',
      activity: 'low',
      projects: 13,
      institutionalCapacity: 12,
      ...
      trend: 'Genome editing is advancing rapidly and offers significant opportunities to improve crop yields, disease resistance, and climate resilience in Cameroon.'
    },
    ghana: {
      name: 'Ghana',
      activity: 'medium',
      ...
      trend: 'The expansion of commercial farming (particularly of cashew, maize, and horticultural crops) was observed. Adoption of improved seed varieties and mechanization is also increasing in some areas, although most farms remain low-input.'
    },
    kenya: {
      name: 'Kenya',
      activity: 'high',
      projects: 13,
      institutionalCapacity: 17,
      priorityOrganisms: 9,
      agreements: [
        'Codex: (Signed-1969)-(Ratified-1969)',
        'UNFCCC: (Signed-1992)-(Ratified-1994)',
      ...
      trend: 'Kenya is increasingly adopting biotech, particularly GEd to address food security and other agricultural challenges, moving from strict GMO regulations to product-based guidelines that facilitate the introduction of GEd products.'
    },
    malawi: {
      name: 'Malawi',
      activity: 'low',
      ...
      trend: 'Malawi domesticated the Cartagena Protocol on Biosafety before its ratification in 2009 by enacting the Biosafety Act of 2002, the Biosafety Regulations of 2007, and the National Biotechnology and Biosafety Policy of 2008.'
    },
    morocco: {
      name: 'Morocco',
      activity: 'medium',
      ...
      trend: 'Genome editing research in Morocco is expanding, with UM6P positioning itself as a North African hub through the African Genome Center and the African BioGenome Project.'
    },
    mozambique: {
      name: 'Mozambique',
      activity: 'medium',
      ...
      trend: 'Agricultural biotechnology, particularly genome editing (GEd), is emerging as a transformative force in African agriculture, offering unprecedented opportunities to improve crop yields, resilience, and nutritional quality.'
    },
    nigeria: {
      name: 'Nigeria',
      activity: 'high',
      projects: 7,
      institutionalCapacity: 20,
      ...
      trend: 'In Nigeria, rapid advancement of genome editing technologies is revolutionizing modern science and enabling precise genetic engineering. Growing interest in applying genome editing to livestock improvement and biomedical research.'
    },
    rwanda: {
      name: 'Rwanda',
      activity: 'medium',
      projects: 3,
      institutionalCapacity: 7,
      priorityOrganisms: 7,
      agreements: [
      ...
      trend: 'Agricultural biotechnology, particularly genome editing, is increasingly recognized as a transformative tool for African agriculture, offering opportunities to enhance crop productivity, quality, and resilience.'
    },
    senegal: {
      name: 'Senegal',
      activity: 'medium',
      projects: 0,
      institutionalCapacity: 16,
      priorityOrganisms: 5,
      agreements: [
        'Codex: (Signed-1966)-(Ratified-1966)',
        'UNFCCC: (Signed-1992)-(Ratified-1994)',
      ...
      trend: 'Senegal\'s Biosafety Law took effect on 14th June 2022, repealing the 2009 Biosecurity Law and establishing a process to allow the entry of R&D and the commercialization of biotech products.'
    },
    'south-africa': {
      name: 'South Africa',
      activity: 'high',
      ...
      trend: 'Genome editing is advancing rapidly and offers significant opportunities to improve crop yields, disease resistance, and climate resilience.'
    },
    zimbabwe: {
      name: 'Zimbabwe',
      activity: 'low',
      ...
      trend: 'Genome editing presents a powerful opportunity to enhance agricultural productivity, climate resilience, and food security in Zimbabwe.'
    }
  };
            ...
            <div className="map-container">
              ...
              >
                <g>
                  ...
                  {/* Senegal */}
                  <path
                    className={`country-region our-work ${selectedCountry === 'senegal' ? 'active' : ''}`}
                    id="Senegal"
                  ...
                  {/* Zimbabwe */}
                  <path
                    className={`country-region our-work ${selectedCountry === 'zimbabwe' ? 'active' : ''}`}
                    id="Zimbabwe"
                  ...
                  {/* Sudan */}
                    ...
                    {/* Djibouti */}
                    <path
                    className={`country-region ${selectedCountry === 'djibouti' ? 'active' : ''}`}
                    id="Djibouti"
                    data-country="djibouti"
                    onClick={() => handleCountryClick('djibouti')}
                    onMouseEnter={(e) => handleCountryHover(e, 'Djibouti')}
                    onMouseLeave={handleCountryLeave}
                    tabIndex="0"
                    role="button"
                    aria-label="Select Djibouti to view genome editing information"
                    ...
                    {/* Seychelles */}
                    <path
                    className={`country-region ${selectedCountry === 'seychelles' ? 'active' : ''}`}
                    id="Seychelles"
                    data-country="seychelles"
                    onClick={() => handleCountryClick('seychelles')}
                    onMouseEnter={(e) => handleCountryHover(e, 'Seychelles')}
                    onMouseLeave={handleCountryLeave}
                    tabIndex="0"
                    role="button"
                    aria-label="Select Seychelles to view genome editing information"
                  ...
                  {/* Add remaining country paths similarly... */}
                  {/* Note: For brevity, I've included key countries. You can add more countries following the same pattern */}
                </g>
              </svg>
                ...
                {selectedCountryData && (
                  <div className="country-content active">
                    <div className="content-header">
                      <h2 className="country-name">{selectedCountryData.name}</h2>
                      <span className={`activity-badge ${getActivityClass(selectedCountryData.activity)}`}>
                        {selectedCountryData.activity === 'high' ? 'Advanced Readiness' : 
                         selectedCountryData.activity === 'medium' ? 'Intermediate Readiness' : 'Foundational Readiness'}
                      </span>
                    </div>

                    <div className="stats-grid">
                      <div className="stat-card">
                        <div className="stat-value">{selectedCountryData.projects}</div>
                        <div className="stat-label">GEd Projects</div>
                      </div>
                      <div className="stat-card">
                        <div className="stat-value">{selectedCountryData.institutionalCapacity}</div>
                        <div className="stat-label">Institutional Capacity</div>
                      </div>
                      <div className="stat-card">
                        <div className="stat-value">{selectedCountryData.priorityOrganisms}</div>
                    ...
                    <div className="info-sections">
                      <div className="info-section">
                        ...
                        <ul className="research-list">
                          {selectedCountryData.agreements.map((agreement, idx) => (
                      ...
                      <div className="info-section">
                        ...
                        <p>{selectedCountryData.priorityOrganismsList}</p>
                      </div>
                    </div>

                    <div className="publications-preview">
                      <h3><i className="fa-solid fa-arrow-trend-up"></i>Trends</h3>
                      <p>{selectedCountryData.trend}</p>
